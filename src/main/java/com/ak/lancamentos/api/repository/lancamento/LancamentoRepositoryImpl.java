...
import com.ak.lancamentos.api.model.Categoria_;
import com.ak.lancamentos.api.model.Lancamento;
import com.ak.lancamentos.api.model.Lancamento_;
import com.ak.lancamentos.api.model.Pessoa_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	public Page<Lancamento> filtrar(LancamentoFilter lancamentoFilter, Pageable pageable) {
		...
		// criar as restrições (são os 'WHERE' da query)
	...
	public Page<ResumoLancamento> resumir(LancamentoFilter lancamentoFilter, Pageable pageable) {
		...
		Root<Lancamento> root = criteria.from(Lancamento.class); // continua o root Lancamento.class
	...
	private void adicionarRestricoesDePaginacao(TypedQuery<?> query, Pageable pageable) {
		int paginaAtual = pageable.getPageNumber(); // começa no 0
